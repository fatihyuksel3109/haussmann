    ...
    <div className="bg-teal-50 ">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="flex justify-between">
          <div className="mt-4">
            <h2 className="text-xl text-black font-semibold uppercase text-center">
              Adresse
            </h2>
            <ul className="text-gray-500 font-medium">
              ...
              <li className="mt-4">
                <p> 9 RUE DES MUGUETS </p>
                <p>67530 Boersch, France</p>
              </li>
            </ul>
          </div>
          <div className="mt-4">
